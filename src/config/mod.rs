...
pub use validation::{
    chain_id_to_network, is_full_url, parse_accept_priority, validate_amount,
    validate_ethereum_address, validate_network, validate_payment_header, validate_resource_path,
    validate_url,
};
...
mod tests {
    ...
    fn test_create_payment_requirements_different_amounts() {
        ...
        for amount_str in amounts {
            ...
            let requirements = config
                .create_payment_requirements("/test")
                .unwrap_or_else(|_| panic!("Should create requirements for amount: {amount_str}"));
            assert!(
